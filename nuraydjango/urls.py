"""
URL configuration for nuraydjango project.
...
urlpatterns = [
    path('admin/', admin.site.urls),  # Admin paneli için URL'yi ekleyin
    ...
    path('parts/update/<int:pk>/', views.part_update, name='part_update'),
    path('parts/delete/<int:pk>/', views.part_delete, name='part_delete'),


]
#    path('', include('kullanici.urls')),  # Diğer URL'ler
